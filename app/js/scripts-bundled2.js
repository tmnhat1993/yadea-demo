...
function () {
  ...
  function Home() {
    ...
    this.imageHolderTimeout = null; // Sliders
  ...
  _createClass(Home, [{
    ...
    value: function bindEvents() {
      ...
      //
      // if(this.slider2){
      //     this.slider2.slick(Object.assign({'fade': false, 'dots': true}, this.sliderOptions))
      // }
      // //</editor-fold>
      //
      //
    ...
    value: function ActiveImageHover(active) {
      ...
      if (active) {
        this.imageHolderTimeout = setTimeout(function () {
          if (_this2.$imageHolderTarget.hasClass('state-1')) {
            _this2.$imageHolderTarget.removeClass('state-1');

            _this2.$imageHolderTarget.addClass('state-2');
          } else {
            if (_this2.$imageHolderTarget.hasClass('state-2')) {
              _this2.$imageHolderTarget.removeClass('state-2');

              _this2.$imageHolderTarget.addClass('state-3');
            } else {
              _this2.$imageHolderTarget.removeClass('state-3');

              _this2.$imageHolderTarget.addClass('state-1');
            }
          }

          _this2.imageHolderInterval = setInterval(function () {
            if (_this2.$imageHolderTarget.hasClass('state-1')) {
              _this2.$imageHolderTarget.removeClass('state-1');
